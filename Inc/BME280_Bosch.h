/*****************************************************************************
* Copyright (C) 2015 - 2016 Bosch Sensortec GmbH* - * Date : 2016/07/04
...
/******************** SPI functions declarations from BME280_user.c ***********************/
#define BME280_API
...
s8 BME280_SPI_bus_write(u8 reg_addr, u8 *reg_data, u8 cnt);
/*	\Brief: The function is used as SPI bus read
 *	\Return : Status of the SPI read
 *	\param reg_addr : Address of the first register, will data is going to be read
 *	\param reg_data : This data read from the sensor, which is hold in an array
 *	\param cnt : The no of byte of data to be read */
s8 BME280_SPI_bus_read(u8 reg_addr, u8 *reg_data, u8 cnt);
/*
